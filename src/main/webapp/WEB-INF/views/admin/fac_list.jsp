		...
		<div class="content">
			<div class="faclist_container">
				<div class="faclist_default">
					<form action="/admin/fac_delete" method="POST" class="board_cont_form" onsubmit="return fac_delete_validate();">
		            ...
		            <div class="board_bottom">
		            	<form action="/admin/fac_list" class="board_bottom_form" name="search_form">
		            		<input type="hidden" value="${attr_code}" id="attr_code" name="attr_code">
			                <!-- sort -->
