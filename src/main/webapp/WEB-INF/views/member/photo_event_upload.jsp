            ...
            <form id="board_form" method="POST" name="photo_event_form" enctype="multipart/form-data">
                ...
                <div class="board_upload_content">
                    ...
                    <select id="province" name="board_location">
                        ...
                        <option value="Tdaejeon">대전</option>
                        <option value="Tgyeongbuk">경상북도</option>
                        <option value="Tdaegu">대구</option>
                    ...
                    <!-- local name -->
                    <input type="text" class="post_name" name="post_name">
                    <!-- file upload -->
                    ...
                    <!-- post tltle -->
                    <input type="text" class="post_title" name="board_title">
                    <!-- post contents -->
                    <textarea name="board_content" id="post_contents"></textarea>
                    <!-- photo_event_form -->
