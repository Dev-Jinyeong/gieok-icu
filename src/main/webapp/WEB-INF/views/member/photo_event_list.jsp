<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="content">
            <!-- contents -->
            <div id="board_form">
            	<form action="/photo_event_listDelete" method="POST" onsubmit="return delete_select();">
	                            ...
	                            <c:forEach var="item" items="${board_list}" varStatus="status">
	                                <li>
	                                    ...
	                                    <div class="photo_info">
	                                        ...
	                                        <span>
	                                            <input type="checkbox" id="board_like_check${status.index}" class="board_like_check">
	                                            <label for="board_like_check${status.index}">
                ...
                <!-- search -->
                <form action="/photo_event_list" name="photo_event_form">
