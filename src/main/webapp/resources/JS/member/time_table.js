...
let scheduleItemDeleteButtonList;
//////////////////////////////////////////////////////////////////////
...
function addSchedule() {
    ...
    addScheduleItemButton.addEventListener("click", () => {
        ...
        createScheduleItem.setAttribute("class", "time_box");
        ...
        createScheduleItemDeleteButton.setAttribute("class", "del");
        ...
        for (let i = 0; i < scheduleItemList.length; i++) {
            scheduleItemDeleteButtonList[i].addEventListener("click", () => {
	        	console.log(scheduleItemList);
	        	console.log(scheduleItemList[i]);
            	deleteSchedule(i);
            	addSchedule()
            });
        }
...
function deleteSchedule(number) {
    ...
    scheduleItemList[number].remove();

    deleteDaySelectOption(number + 1);
...
function reloadScheduleItemList() {
    scheduleItemList = document.querySelectorAll(".time_box");
    scheduleItemDeleteButtonList = document.querySelectorAll(".del");

    if (scheduleItemList.length-1 > 0) {
        for (let i = 0; i < scheduleItemList.length-1; i++) {
    ...
    console.log("---------------------");
    console.log(scheduleItemList);
    console.log(scheduleItemDeleteButtonList);
}
